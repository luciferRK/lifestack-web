...
describe('healthService', () => {
  ...
  it('calls medication endpoints with expected params/bodies', async () => {
    ...
    await healthService.upsertMedicationEvent('med-1', {
    ...
    expect(api.get).toHaveBeenNthCalledWith(2, '/health/medications/schedule', {
  ...
  it('calls weight endpoints with expected params/bodies', async () => {
    ...
    expect(api.post).toHaveBeenCalledWith('/health/weight', {
      measured_at: '2026-01-01T09:00:00Z',
      weight_kg: '72.4',
    });
