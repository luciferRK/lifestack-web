...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-32 overflow-hidden rounded-lg border border-slate-700 bg-slate-900 p-1 text-slate-100 shadow-2xl shadow-slate-950/60',
      className,
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-40 overflow-hidden rounded-lg border border-slate-700 bg-slate-900 p-1 text-slate-100 shadow-2xl shadow-slate-950/60',
        className,
      )}
      {...props}
    />
