  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label:
          'inline-flex items-center gap-1 rounded-lg border border-slate-700 bg-slate-950/50 px-2.5 py-1.5 text-sm font-medium text-slate-100',
        ...
        button_previous:
          'pointer-events-auto inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-700 bg-slate-950/50 text-slate-300 hover:bg-slate-800 hover:text-white',
        button_next:
          'pointer-events-auto inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-700 bg-slate-950/50 text-slate-300 hover:bg-slate-800 hover:text-white',
        ...
        selected:
          'bg-cyan-600 text-white hover:bg-cyan-500 hover:text-white focus:bg-cyan-600 focus:text-white',
