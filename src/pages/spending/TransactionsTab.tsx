      ...
      {transactions?.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-800 bg-slate-800/30 p-12 text-center">
          ...
          <p className="text-slate-400">
            Start tracking your spending by adding a new transaction.
          </p>
          {onAddFirst ? (
            <button
              onClick={onAddFirst}
            ...
            {transactions?.map((tx) => {
              ...
              return (
                ...
                >
                  ...
                  {tx.description ? (
                    <p
                      data-testid="transaction-description-card"
                ...
                {transactions?.map((tx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <p
                          data-testid="transaction-description-table"
                        ...
                        <div className="flex max-w-[220px] flex-wrap gap-1">
                          ...
                          {sourceMetadata ? (
                            <span
                              ...
                              title={
                                sourceMetadata.rollback_supported &&
                                sourceMetadata.import_row_number
